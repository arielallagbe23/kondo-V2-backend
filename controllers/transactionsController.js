...
exports.addBacktestTransaction = async (req, res) => {
    try {
        ...
        if (!session_backtest_id || !actif_id || !type_ordre_id || !timeframe_id || !resultat_id || !date_entree || !risque || !status) {
        ...
        const sql = `
            ...
            (user_id, session_backtest_id, type_ordre_id, actif_id, strategie_id, timeframe_id, resultat_id, date_entree, rrp, risque, status) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `;
...
exports.getEnCoursTransactions = async (req, res) => {
    try {
        const sql = `
            ...
            LEFT JOIN 
                types_ordres to_ ON tb.type_ordre_id = to_.id
            LEFT JOIN 
...
exports.updateTransaction = async (req, res) => {
    try {
        ...
        if (!user_id && !session_backtest_id && !actif_id && !type_ordre_id && !strategie_id && 
        ...
        if (type_ordre_id) updateFields.push("type_ordre_id = ?");
        ...
        values = [user_id, session_backtest_id, actif_id, type_ordre_id, strategie_id, timeframe_id, resultat_id, date_entree, rrp, risque, status]
